...
beforeEach(async() => {
    /*Deploys a new instance of Airline on the specified network, and maps it to the instance */
    instance = await Airline.new();
});

/*Truffle gives us all the accounts that we have available to deploy and test */
contract('Airline', accounts => {
    ...
    it('should get the real balance of the contract', async() => {
        ...
        assert(newAirlineBalance.toNumber(), (price.toNumber() + price2.toNumber()));
    });
